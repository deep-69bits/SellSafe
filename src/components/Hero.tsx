...
const Hero = () => {
    return (
        <div className='mx-auto  rounded-full bg flex justify-center gap-x-20  w-full lg:w-1/2  lg:py-10 pt-10 '>
            ...
            <div className='hidden lg:block'>
                <Image className='absolute translate-y-[300px] translate-x-[0px]   cursor-pointer hover:scale-110 transition-all duration-300' src={'/Images/camera.png'} width={142} height={110} alt='Camer' />
                ...
                <Image className='absolute translate-y-[150px]  translate-x-[-120px] cursor-pointer hover:scale-110 transition-all duration-300' src={'/Images/phone.png'} width={105} height={125} alt='Phone' />
            </div>
        </div>
    )
}
